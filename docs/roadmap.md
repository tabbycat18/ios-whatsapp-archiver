...
- Chat wallpaper rendering from generic archive-root `current_wallpaper.jpg` and `current_wallpaper_dark.jpg` files, plus a local Default/Classic/Soft Pattern/Demo/Plain selector.
